...
"""
cuadros = [
    [Cuadro("assets/Bag.png"), Cuadro("assets/Bag.png"),
     Cuadro("assets/Pullover.png"), Cuadro("assets/Pullover.png")],
    [Cuadro("assets/Sandal.png"), Cuadro("assets/Sandal.png"),
     Cuadro("assets/Ankle boot.png"), Cuadro("assets/Ankle boot.png")],
    [Cuadro("assets/Coat.png"), Cuadro("assets/Coat.png"),
     Cuadro("assets/PulloverBlack.png"), Cuadro("assets/PulloverBlack.png")],
    [Cuadro("assets/T-shirttop.png"), Cuadro("assets/T-shirttop.png"),
     Cuadro("assets/T-shirttopBlack.png"), Cuadro("assets/T-shirttopBlack.png")],
]
